...
| `switch.<camera>_wake_sound` | Bắt được từ gọi thì loa camera kêu **"ting"** (~0,3 s) — biết là nói được; nói SAU tiếng ting (mic bỏ tiếng tới lúc ting dứt để không nghe nhầm chính nó). Mặc định bật. |
